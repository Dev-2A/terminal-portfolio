const projects = [
  ...
  },
  {
    id: 'terminal-portfolio',
    name: 'Terminal Portfolio',
    description: '브라우저에서 터미널 명령어로 탐색하는 인터랙티브 개발자 포트폴리오. 가상 파일시스템, 8가지 테마, ASCII 아트 배너.',
    stack: ['React', 'Vite', 'Tailwind CSS'],
    github: 'https://github.com/Dev-2A/terminal-portfolio',
    live: 'https://dev-2a.github.io',
    date: '2026-03',
    category: 'web',
  },
  {
    ...
    description: 'SNS 공유용 OG 카드 이미지 생성기. Satori로 서버리스 이미지 생성, 터미널 포트폴리오의 8가지 테마 재활용.',
  ...
  },
  {
    ...
    live: 'https://ffxiv-loot-tracker.vercel.app',
    date: '2026-04',
    category: 'web',
  },
];
